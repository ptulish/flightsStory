...
export const AIRLINES = {
  ...
  OS: { code: 'OS', name: 'Austrian', color: '#cb0000' },
  EW: { code: 'EW', name: 'Eurowings', color: '#883e92' },
  LX: { code: 'LX', name: 'SWISS', color: '#dc0d15' },
  SN: { code: 'SN', name: 'Brussels Airlines', color: '#00305e' },
  LO: { code: 'LO', name: 'LOT', color: '#0c2340' },
  SK: { code: 'SK', name: 'SAS', color: '#003087' },
  A3: { code: 'A3', name: 'Aegean', color: '#16448f' },
  TP: { code: 'TP', name: 'TAP Air Portugal', color: '#7fb641' },
  EN: { code: 'EN', name: 'Air Dolomiti', color: '#00629b' },
